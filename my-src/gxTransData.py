...
class SummaryClassifier:
    SUMMARY_CLASSIFICATION = {
        ...
        '自有资金还融资': {'成交数量标志': 0, '发生金额标志': 1, '银行标志': 0},
        '融入方初始交易': {'成交数量标志': 0, '发生金额标志': 1, '银行标志': 0},  # 这是融资账未拆分时的，和下一条之间差了个利息
        '融入购回减资金': {'成交数量标志': 0, '发生金额标志': 1, '银行标志': 0},
        '融券回购': {'成交数量标志': 1, '发生金额标志': 1},
        '融券购回': {'成交数量标志': -1, '发生金额标志': 1},
        '融资借款': {'成交数量标志': 0, '发生金额标志': 1, '银行标志': 0},  # 融资借款不是银行转入转出部分，是账户内消耗
        '融资利息': {'成交数量标志': 1, '发生金额标志': 1, '银行标志': 0},  # 融资利息不是银行转入转出部分，是账户内消耗
        '融资平仓': {'成交数量标志': -1, '发生金额标志': 1},
        '融资开仓': {'成交数量标志': 1, '发生金额标志': 1},
        '融资还款': {'成交数量标志': 0, '发生金额标志': 1, '银行标志': 0},
        ...
        '资金自动还融资': {'成交数量标志': 0, '发生金额标志': 1, '银行标志': 0},
        '银行转证券': {'成交数量标志': -1, '发生金额标志': 1, '银行标志': 1},
    }

    # 专门用于统计融资账户的借款余额的summary定义
    RONGZI_CASHFLOW_SUMMARY= {"融资还款", "资金自动还融资", "自有资金还融资", "融资借款", "融入方初始交易", "融入购回减资金"}

    # 用于统计新股申购之类的账户资金冻结的summary定义
    FROZEN_CASHFLOW_SUMMARY = {"新股申购", "申购还款"}
